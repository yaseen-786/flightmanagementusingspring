...
<html lang="en">
  <head>
    ...
    <title>Flight Updation</title>
  </head>
  <body>
    <div class="container mt-10">
    <h1>Flight Updation Form<h1><br>
    <form action="flightupdating" method="post">
  ...
  <div class="form-group">
    ...
    name="capacity" value="${flight.capacity} ">
   </div>
    <div class="form-group">
    ...
    name="duration" value="${flight.duration} ">
   </div>
